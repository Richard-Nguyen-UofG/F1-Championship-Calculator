...
DRIVER_STANDINGS = [
                    [134, 120, 79], [100, 82, 68], [150, 63, 59], [103, 90, 77], [94, 90, 83],
                    [98, 93, 82], [147, 144, 101], [123, 81, 80], [129, 100, 88], [124, 95, 90]
                   ]

for div in range(10):
    DRIVERX_POINTS = DRIVER_STANDINGS[div]
    NUM_DRIVERS = len(DRIVERX_POINTS)
    
    SCORE_SYSTEM = [25, 18, 15, 12, 10, 8, 6, 4, 2, 1]
    ...
    print(str(div+1) + ' duration: ' + str(end - start))
